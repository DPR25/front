...
export default function Card(props) {
    ...
    return (
        ...
        <div className='w-100 h-100 rounded-2xl'>
            ...
            <div className='absolute top-0 left-10 w-95 h-95 border rounded-xl overflow-hidden bg-[#2e2e2e] '>
                <img src={props.mask_path} 
                className='w-full h-full'
                alt="" />
            </div>

            <div className='absolute top-10 left-0 w-95 h-95 rounded-xl overflow-hidden'>
